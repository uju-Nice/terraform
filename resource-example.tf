...
#     key = "key/bucket/Terraform_statefiles"     // Path to where to keep your bucket once objects are in
#   }
# }
...
# # This user-date is inside the install.sh file  or use the inline user_data as below example 
